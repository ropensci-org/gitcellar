...
This is a basic example which shows you how to download archives of all repositories in an organization:
...
The archives (.tar.gz) will be saved in distinct folders under the current directory (or the directory you input via the argument `dest_folder`).
